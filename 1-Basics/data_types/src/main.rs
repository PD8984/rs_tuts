fn main() {
    ...
    // let x = 2.0; //f64 befault because on modern CPUs
    // let y: f32 = 1.0;
    //
    // let t = true;
    // let f: bool = false;
    ...
    // let tut = "rs".to_string();
    // let new_name = name.replace("Preet", "Mr. Preet");
    //
    // println!("{}", name);
    // println!("{}", tut);
    // println!("{}", new_name);
